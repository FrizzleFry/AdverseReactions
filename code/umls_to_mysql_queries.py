...
def createTable(tableName):
   ...
   if tableName == "RXNATOMARCHIVE":
      query = """CREATE TABLE RXNATOMARCHIVE
      (
   ...
   elif tableName == "RXNCUICHANGES":
      query = """CREATE TABLE RXNCUICHANGES
      (
            RXAUI         varchar(8),
            CODE          varchar(50),
            SAB           varchar(20),
...
def insertTable(tableName,values):
   if tableName == "RXNATOMARCHIVE":
      query = """INSERT INTO RXNATOMARCHIVE
      ...
      query = """INSERT INTO RXNCONSO(RXCUI,LAT,TS,LUI,STT,SUI,ISPREF,RXAUI,SAUI,SCUI,SDUI,SAB,TTY,CODE,STR,SRL,SUPPRESS,CVF)
