  ...
  for file in files:
    ...
    for i, d in enumerate(data):
      ...
      try:
        ...
        main_table = jsonToDict(d,'duplicate',main_table,'duplicate')
        main_table = jsonToDict(d,'receivedate',main_table,'receivedate')
        main_table = jsonToDict(d,'receiptdate',main_table,'receiptdate')
        main_table = jsonToDict(d,'serious',main_table,'serious')
        main_table = jsonToDict(d,'transmissiondate',main_table,'transmissiondate')
        ...
        query_insert = """INSERT INTO main_table VALUES('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');""" %values
